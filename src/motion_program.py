...
# Construct the absolute path to the config file (up one level -> config folder)
config_path = os.path.join(script_dir, '..', 'config', 'ABB_1200_5_90_robot_default_config.yml')
